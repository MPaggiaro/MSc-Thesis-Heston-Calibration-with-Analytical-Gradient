...
void asinv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_asinv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void asinfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_asinfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);

void acosv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_acosv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void acosfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_acosfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
