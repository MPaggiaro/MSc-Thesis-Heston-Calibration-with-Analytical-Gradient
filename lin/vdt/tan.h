...
void tanv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_tanv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void tanfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_tanfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
