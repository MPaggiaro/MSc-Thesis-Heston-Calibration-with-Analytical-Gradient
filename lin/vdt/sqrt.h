...
void isqrtv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_isqrtv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_approx_isqrtv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void isqrtfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_isqrtfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_approx_isqrtfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
