...
void atan2v(const uint32_t size, double const * __restrict iarray, double const * __restrict iarray2, double* __restrict oarray);
void fast_atan2v(const uint32_t size, double const * __restrict iarray, double const * __restrict iarray2, double* __restrict oarray);
void atan2fv(const uint32_t size, float const * __restrict iarray, float const * __restrict iarray2, float* __restrict oarray);
void fast_atan2fv(const uint32_t size, float const * __restrict iarray, float const * __restrict iarray2, float* __restrict oarray);
