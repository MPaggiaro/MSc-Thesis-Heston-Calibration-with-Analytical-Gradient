...
void invv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_invv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void fast_approx_invv(const uint32_t size, double const * __restrict iarray, double* __restrict oarray);
void invfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_invfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
void fast_approx_invfv(const uint32_t size, float const * __restrict iarray, float* __restrict oarray);
