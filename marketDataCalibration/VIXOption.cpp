...
VIXOption::VIXOption(const double K, const double T, const double r, double kappa, double theta,
...
VIXOption::VIXOption(double K, double T, double r, double S0, std::string optType, unsigned int nParameters, double q,
