...
SPXOption::SPXOption (const double K, const double T, const double r, double kappa, double theta,
                      double sigma, double rho, double v0, double S0, std::string  optType,
                      unsigned nParameters, double q,
                      std::string cfType,const double N):
        EuropeanOption(K,T,r,kappa, theta, sigma, rho, v0, S0, std::move(optType),
                       nParameters,q,std::move(cfType),N) { }

SPXOption::SPXOption(double K, double T, double r, double S0, std::string optType, unsigned int nParameters, double q,
                     std::string cfType, double N) :
        EuropeanOption(K, T, r, S0, std::move(optType), nParameters, q, std::move(cfType), N){}
